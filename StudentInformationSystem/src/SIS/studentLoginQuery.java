...
public class studentLoginQuery extends DatabaseController{
...
//        String checkQuery = "select * from loginDetails where user = '"+uname+"' and pass = '"+pass+"' ";
        String checkQuery = "select *from studentLogin where id = ? and password = ? "; // i don't use id from database table.
