...
public class AttendanceInsertionQuery{
    @FXML
    ...
    public void insert(ActionEvent actionEvent) {
        ...
        if(!subName.contains("placements")) {
            ...
            String subAttendance = count.getText();
            System.out.println(stuID+" "+subAttendance);
            if(!subAttendance.isEmpty()&&!stuID.isEmpty()) {
                ...
                String checkUpdateQuery = "update stuSubAttendanceDetails set "+subName+" = ? where id = ?";
                PreparedStatement prepareStatement = null;
                try {
                    prepareStatement = conn.prepareStatement(checkUpdateQuery);
                    prepareStatement.setString(1, subAttendance); // sending password to checkquery statement
